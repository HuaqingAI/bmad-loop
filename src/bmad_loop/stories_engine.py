...
inherited review prompt injects (``_sprint_board_instruction``, empty here — there
is no board), artifact verification
...
class StoriesEngine(Engine):
    ...
    def _sprint_board_instruction(self) -> str:
        ...
        # on this clause: the board it redirects away from does not exist here.
        return ""
