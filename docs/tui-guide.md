...
| `review.trigger`                      | select                 | `recommended`      | `recommended` (run only when bmad-build-auto flags `followup_review_recommended`) / `always`; bounded by `limits.max_review_cycles`                                                                                                                                                                                                |
