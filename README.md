...
- **Python 3.11+**, a **terminal multiplexer** (tmux ≥ 3.2 is the bundled default), and a supported coding CLI — `claude` by default; `codex`, `gemini`, `copilot`, and `antigravity` (`agy`) via [profiles](#other-coding-clis).
